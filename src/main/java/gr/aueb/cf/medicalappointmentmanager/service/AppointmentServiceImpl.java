...
import gr.aueb.cf.medicalappointmentmanager.model.*;
import gr.aueb.cf.medicalappointmentmanager.repository.AppointmentRepository;
import gr.aueb.cf.medicalappointmentmanager.repository.DoctorRepository;
import gr.aueb.cf.medicalappointmentmanager.repository.PatientRepository;
...
public class AppointmentServiceImpl implements IAppointmentService {
    ...
    @Autowired
    public AppointmentServiceImpl(AppointmentRepository appointmentRepository, DoctorRepository doctorRepository, PatientRepository patientRepository, UserRepository userRepository, IPatientService patientService) {
    ...
    private boolean isAppointmentTimeFree(LocalDateTime dateTime, Long doctorId) {
        ...
        List<Appointment> appointments = appointmentRepository.findAppointmentByDoctorIdAndAppointmentDateTimeBetween(doctorId, dateTime, appointmentEndTime);
